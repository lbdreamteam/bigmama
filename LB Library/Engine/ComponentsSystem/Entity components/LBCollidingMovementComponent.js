LBCollidingMovementComponent = function (agent, h, moving, type, graph, leftOffset, rightOffset) {
    ...
    this.sendDelegate('startMoving', function (params) {
...
LBCollidingMovementComponent.prototype.init = function () {
    //CHEIDERE AD ASCARI DI SPIEGARE A MODO E PARAMETRI NEI DELEGATE
